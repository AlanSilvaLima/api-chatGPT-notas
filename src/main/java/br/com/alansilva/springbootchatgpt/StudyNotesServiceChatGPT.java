package br.com.alansilva.springbootchatgpt;
...
public class StudyNotesServiceChatGPT {
    ...
    private ChatGPTRequest createStudyRequest(String topic) {
        String question = "Quais são os pontos chave que devo estudar sobre o seguinte assunto: PL/SQL"
        + topic;
        return new ChatGPTRequest("text-davinci-003", question, 0.3,
            1500, 1.0,
            0.0, 0.0);
    }
}
